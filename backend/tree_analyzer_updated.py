...
class TreeAnalyzer:
    ...
    def calculate_height(self, tree_pixels, image_height, reference_pixels=None, reference_height=1.7):
        ...
        if reference_pixels and reference_height > 0:
            ...
            return max(10.0, min(corrected_height * 10, 500.0))
            ...
            # Multiply by 10 as requested
            return max(10.0, min(final_height * 10, 450.0))
    ...
    def _fallback(self, image_path, image_height):
        ...
        try:
            ...
            # Multiply by 10 as requested
            return max(10.0, min(estimated_height * 10, 350.0))
            
        except:
            return 125.0  # Default fallback multiplied by 10
